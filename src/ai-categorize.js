...
- Each account belongs to a different company. An inbound wire, ACH or "transfer" from another business is real income: use "Revenue" when it pays for products or services, "Distributions" for owner/member distributions, "Capital contributions" when an owner or partner puts money into the company. Use "Transfers" ONLY for a payment to the company's own credit card (e.g. "AMEX EPAYMENT", "PAYMENT THANK YOU").
